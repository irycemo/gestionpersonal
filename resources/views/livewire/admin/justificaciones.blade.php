...
<div class="">
    ...
    <div class="mb-5">
        ...
        <h1 class="text-3xl tracking-widest py-3 px-6 text-gray-600 rounded-xl border-b-2 border-gray-500 font-thin mb-6  bg-white">Justificaciones</h1>
                    ...
                    @foreach($justificaciones as $justificacion)
                        ...
                        <tr class="text-sm font-medium text-gray-500 bg-white flex lg:table-row flex-row lg:flex-row flex-wrap lg:flex-no-wrap mb-10 lg:mb-0">
                            ...
                            <td class="px-3 py-3 w-full lg:w-auto p-3 text-gray-800 text-center lg:text-left lg:border-0 border border-b block lg:table-cell relative lg:static">
                                ...
                                <a href="{{ route('personal') . '?search=' . $justificacion->persona->curp }}">{{ $justificacion->persona->nombre}} {{ $justificacion->persona->ap_paterno }} {{ $justificacion->persona->ap_materno }}</a>
                            ...
                            <td class="px-3 py-3 w-full lg:w-auto p-3 text-gray-800 text-center lg:text-left lg:border-0 border border-b lg:table-cell relative lg:static">
                                ...
                                <div class="flex justify-center lg:justify-start">
                                    ...
                                    @can('Editar justificacion')
                                        ...
                                        <button
                                            wire:click="abiriModalEditar({{$justificacion}})"
                                            wire:loading.attr="disabled"
                                            wire:target="abiriModalEditar({{$justificacion}})"
                                    ...
                                    @can('Borrar justificacion')
                                        ...
                                        <button
                                            wire:click="abrirModalBorrar({{$justificacion}})"
                                            wire:loading.attr="disabled"
                                            wire:target="abrirModalBorrar({{$justificacion}})"
