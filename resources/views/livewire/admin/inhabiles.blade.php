<div class="">
    ...
    <div class="mb-5">
        ...
        <h1 class="text-3xl font-thin text-gray-500 mb-3">Dias Inhábiles</h1>
        ...
        <div class="flex justify-between">
            ...
            @can('Crear inhabil')
                ...
                <button wire:click="abrirModalCrear" class="bg-gray-500 hover:shadow-lg hover:bg-gray-700 float-right mb-5 text-sm py-2 px-4 text-white rounded-full focus:outline-none hidden md:block">Agregar día inhábil</button>
