            ...
            <div class="float-righ">
                ...
                @if($crear)
                    ...
                    <button
                        ...
                        wire:loading.attr="disabled"
                        wire:target="crear"
                        class="bg-blue-400 text-black hover:shadow-lg text-white font-bold px-4 py-2 rounded-full text-sm mb-2 hover:bg-blue-700 flaot-left mr-1 focus:outline-none">
                        Guardar
                    </button>
