<div>
    ...
    <div class="md:flex flex-col md:flex-row justify-between md:space-x-3 items-center bg-white rounded-xl mb-5 p-4">
        ...
        <div class="flex-auto ">
            ...
            <div>
                ...
                <select class="rounded text-sm w-full" wire:model="falta_empleado">
        ...
        <div class="flex-auto ">
            ...
            <div>
                ...
                <input type="text" class="rounded text-sm w-full" wire:model="falta_tipo">
    ...
    @if(count($faltas))
        ...
        <div class="rounded-lg shadow-xl mb-5 p-4 font-thin md:flex items-center justify-between bg-white">
            ...
            <p class="text-xl font-extralight">Se encontraron: {{ number_format($faltas->total()) }} registros con los filtros seleccionados.</p>
