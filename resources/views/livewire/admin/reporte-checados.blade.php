    ...
    <div class="md:flex flex-col md:flex-row justify-between md:space-x-3 items-center bg-white rounded-xl mb-5 p-4">
        ...
        <div class="flex-auto ">
            ...
            <div>
                ...
                <select class="rounded text-sm w-full" wire:model="empleado_id">
        ...
        <div class="flex-auto ">
            ...
            <div>
                ...
                <select class="rounded text-sm w-full" wire:model="status">
        ...
        <div class="flex-auto ">
            ...
            <div>
                ...
                <select class="rounded text-sm w-full" wire:model="tipo">
        ...
        <div class="flex-auto ">
            ...
            <div>
                ...
                <select class="rounded text-sm w-full" wire:model="horario_id">
