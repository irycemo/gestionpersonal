            ...
            <nav class="p-4 text-rojo overflow-y-auto h-menu" x-data="{openRoles:true, openArticles:true}">
                ...
                @can('Lista de roles')
                    ...
                    <div class="flex items-center mb-3 w-full justify-between hover:text-red-600 transition ease-in-out duration-500 hover:bg-gray-100 rounded-xl">
                        ...
                        <a href="{{ route('roles') }}" class=" capitalize text-md  flex hover w-full  p-2 px-4 ">
                ...
                <div
                    ...
                    <a href="{{ route('permisos') }}" class=" capitalize text-md  flex hover w-full   p-2 px-4 ml-5">
                ...
                @can('Lista de usuarios')
                    ...
                    <a href="{{ route('usuarios') }}" class="mb-3 capitalize text-md hover:text-red-600 transition ease-in-out duration-500 flex hover  hover:bg-gray-100 p-2 px-4 rounded-xl">
                ...
                @can('Lista de horarios')
                    ...
                    <a href="{{ route('horarios') }}" class="mb-3 capitalize text-md hover:text-red-600 transition ease-in-out duration-500 flex hover  hover:bg-gray-100 p-2 px-4 rounded-xl">
                ...
                <div
                    ...
                    <a href="#" class=" capitalize text-md  flex hover w-full  hover:bg-gray-100 p-2 px-4 ml-5">
                ...
                @can('Lista de permisos personal')
                    ...
                    <a href="{{ route('permisos_personal') }}" class="mb-3 capitalize text-md hover:text-red-600 transition ease-in-out duration-500 flex hover  hover:bg-gray-100 p-2 px-4 rounded-xl">
                ...
                @can('Lista de incapacidades')
                    ...
                    <a href="{{ route('incapacidades') }}" class="mb-3 capitalize text-md hover:text-red-600 transition ease-in-out duration-500 flex hover  hover:bg-gray-100 p-2 px-4 rounded-xl">
                ...
                @can('Lista de justificaciones')
                    ...
                    <a href="{{ route('justificaciones') }}" class="mb-3 capitalize text-md hover:text-red-600 transition ease-in-out duration-500 flex hover  hover:bg-gray-100 p-2 px-4 rounded-xl">
                ...
                @can('Lista de inhabiles')
                    ...
                    <a href="{{ route('inhabiles') }}" class="mb-3 capitalize text-md hover:text-red-600 transition ease-in-out duration-500 flex hover  hover:bg-gray-100 p-2 px-4 rounded-xl">
                ...
                @can('Reportes')
                    ...
                    <a href="{{ route('reportes') }}" class="mb-3 capitalize text-md hover:text-red-600 transition ease-in-out duration-500 flex hover  hover:bg-gray-100 p-2 px-4 rounded-xl">
                ...
                @can('Reportes')
                    ...
                    <a href="{{ route('checador') }}" class="mb-3 capitalize text-md hover:text-red-600 transition ease-in-out duration-500 flex hover  hover:bg-gray-100 p-2 px-4 rounded-xl">
                ...
                @can('Lista de personal')
                    ...
                    <a href="{{ route('personal') }}" class="mb-3 capitalize text-md hover:text-red-600 transition ease-in-out duration-500 flex hover  hover:bg-gray-100 p-2 px-4 rounded-xl">
                ...
                @can('Formatos')
                    ...
                    <a href="{{ route('formatos') }}" class="mb-3 capitalize text-md hover:text-red-600 transition ease-in-out duration-500 flex hover  hover:bg-gray-100 p-2 px-4 rounded-xl">
                ...
                <a href="{{ route('manual') }}" class="mb-3 capitalize text-md hover:text-red-600 transition ease-in-out duration-500 flex hover  hover:bg-gray-100 p-2 px-4 rounded-xl">
                ...
                @if (auth()->user()->hasRole('Administrador'))
                    ...
                    <a href="{{ url('log-viewer') }}" class="mb-3 capitalize text-md hover:text-red-600 transition ease-in-out duration-500 flex hover  hover:bg-gray-100 p-2 px-4 rounded-xl">
                    ...
                    <a href="{{ url('auditoria') }}" class="mb-3 capitalize text-md hover:text-red-600 transition ease-in-out duration-500 flex hover  hover:bg-gray-100 p-2 px-4 rounded-xl">
