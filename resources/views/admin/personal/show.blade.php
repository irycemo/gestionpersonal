    ...
    <div>
        ...
        <div class="w-full" x-data="{selected : null}">
            ...
            >
                ...
                @livewire('admin.personal.incapacidades', ['persona' => $persona])
            ...
            >
                ...
                @livewire('admin.personal.justificaciones', ['persona' => $persona])
            ...
            >
                ...
                @livewire('admin.personal.retardos', ['persona' => $persona])
