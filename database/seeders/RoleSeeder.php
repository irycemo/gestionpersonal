...
class RoleSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Permission::create(['name' => 'Lista de horarios', 'area' => 'Horarios'])->syncRoles([$role1, $role2, $role3]);
        Permission::create(['name' => 'Crear horario', 'area' => 'Horarios'])->syncRoles([$role1, $role2, $role3]);
        Permission::create(['name' => 'Editar horario', 'area' => 'Horarios'])->syncRoles([$role1, $role2, $role3]);
        Permission::create(['name' => 'Borrar horario', 'area' => 'Horarios'])->syncRoles([$role1]);

        Permission::create(['name' => 'Lista de permisos personal', 'area' => 'Permisos Personal'])->syncRoles([$role1, $role2, $role3]);
        Permission::create(['name' => 'Crear permiso personal', 'area' => 'Permisos Personal'])->syncRoles([$role1, $role2, $role3]);
        ...
        Permission::create(['name' => 'Editar incapacidad', 'area' => 'Incapacidades'])->syncRoles([$role1, $role2, $role3]);
        Permission::create(['name' => 'Borrar incapacidad', 'area' => 'Incapacidades'])->syncRoles([$role1]);

        Permission::create(['name' => 'Lista de personal', 'area' => 'Personal'])->syncRoles([$role1, $role2, $role3]);
        Permission::create(['name' => 'Crear personal', 'area' => 'Personal'])->syncRoles([$role1, $role2, $role3]);
        Permission::create(['name' => 'Editar personal', 'area' => 'Personal'])->syncRoles([$role1, $role2, $role3]);
        Permission::create(['name' => 'Borrar personal', 'area' => 'Personal'])->syncRoles([$role1]);
        Permission::create(['name' => 'Ver personal', 'area' => 'Personal'])->syncRoles([$role1, $role2, $role3]);

        Permission::create(['name' => 'Lista de justificaciones', 'area' => 'Justificación'])->syncRoles([$role1, $role2, $role3]);
        Permission::create(['name' => 'Crear justificacion', 'area' => 'Justificación'])->syncRoles([$role1, $role2, $role3]);
        ...
        Permission::create(['name' => 'Lista de inhabiles', 'area' => 'Inhábiles'])->syncRoles([$role1, $role2, $role3]);
        Permission::create(['name' => 'Crear inhabil', 'area' => 'Inhábiles'])->syncRoles([$role1, $role2]);
        Permission::create(['name' => 'Editar inhabil', 'area' => 'Inhábiles'])->syncRoles([$role1, $role2, $role3]);
        Permission::create(['name' => 'Borrar inhabil', 'area' => 'Inhábiles'])->syncRoles([$role1]);

        Permission::create(['name' => 'Reportes', 'area' => 'Reportes'])->syncRoles([$role1, $role2, $role3]);

        Permission::create(['name' => 'Checador', 'area' => 'Checador'])->syncRoles([$role1, $role2, $role3, $role4]);
